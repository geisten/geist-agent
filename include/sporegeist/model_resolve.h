#ifndef SPOREGEIST_MODEL_RESOLVE_H
#define SPOREGEIST_MODEL_RESOLVE_H
 ...
 *   2. the SPOREGEIST_MODEL environment variable
 ...
 * (override the URL via SPOREGEIST_MODEL_URL). On success the chosen path is
